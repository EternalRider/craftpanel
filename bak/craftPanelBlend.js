import { HandlebarsApplication, getItemColor, MODULE_ID, debug, chatMessage, getFolder, multiShowOptions, multiValueOptions } from "../utils.js";
    ...
    async refreshResults() {
        ...
        if ((showResult === "show" || showResult === "question mark" || showResult == "by unlock") && this.checkSlot()) {
            ...
            if (recipes.length > 0) {
                ...
                debug("CraftPanelBlend refreshResults : this.results", this.results);
            }
        }
    }
    //刷新材料面板
